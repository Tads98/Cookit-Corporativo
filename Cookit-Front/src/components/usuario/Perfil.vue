<template>
  <div
   ...
   class="container">
    ...
    >
      <div v-if="user.visivel" id="dados-receita-completa">
        <div class="row">
          ...
          <div class="row">
            <div class="col mb-3">
              <div id="icones-receita-completa" class="col">
                <div
                  class="col line-receita-completa"
                  style="border: none"
                >
      ...
      <div v-else id="dados-receita-completa">
        <h1>Desculpe! :(</h1>
        <p>Este perfil não existe ou foi desativado.</p>
      </div>
    </div>
  </div>
</template>
